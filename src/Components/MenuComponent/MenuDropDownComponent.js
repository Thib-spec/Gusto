  ...
  return (
    <div className="menu-list-element">
      {open === true ? (
        <div>
          <div
            className="menu-list-element-title-fold"
            onClick={() => handleOpen()}
          >
          ...
          <div className="menu-list-element-sub">
            <div className="menu-list-element-sub-description">
              ...
              {allProductsInMenu2.value.map((product) => (
                <div>
                  ...
                  <ProductMenu
                    product2={allProductsInMenu2.get(product.id_product)}
                    allProductsInMenu2={allProductsInMenu2}
                  />
                </div>
              ))}
            </div>
            <div class="menu-list-element-sub-buttons ">
              <button
                type="button"
                className="menu-list-element-sub-buttons-element btn btn-info"
                onClick={() => handleSave()}
              >
                Enregistrer
              </button>
              <button
                type="button"
                className="menu-list-element-sub-buttons-element btn btn-danger"
                onClick={() => handleShow()}
              >
                Supprimer
              </button>
