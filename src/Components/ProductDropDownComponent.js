...
export default function ProductDropDownComponent(props) {
  ...
  function handleDelete() {
    try {
      axios
        .delete(
          "http://api.gustosolutions.fr/api/product/" + props.product.id_product
        )
        .then((res) => {
          console.log(res);
  ...
  return (
    <div className="products-list-element">
      {open ? (
        <div>
          <div
            className="products-list-element-title-fold"
            onClick={() => handleOpen()}
          >
          ...
          <div className="products-list-element-sub">
            <div className="products-list-element-sub-description">
              ...
              <textarea
                type="text"
                className=" products-list-element-sub-description-input"
                id={"descriptionProduct" + props.product.id_product}
                placeholder="Description du produit"
              >
                {props.product.description}
              </textarea>
            </div>
            <div className="products-list-element-sub-buttons ">
              <button
                type="button"
                className="products-list-element-sub-buttons-element btn btn-info"
              >
                Enregistrer
              </button>
              <button
                type="button"
                className="products-list-element-sub-buttons-element btn btn-danger"
